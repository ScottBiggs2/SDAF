...
def comparison_table(runs: Iterable[TrainingRun]) -> dict:
    ...
    for r in runs:
        ...
        out["runs"].append({
            ...
            "prefix_n_attn_blocks": r.summary.get("prefix_n_attn_blocks"),
            "prefix_n_heads": r.summary.get("prefix_n_heads"),
            "prefix_d_ff": r.summary.get("prefix_d_ff"),
            "prefix_ctx_len": r.summary.get("prefix_ctx_len"),
            "grad_clip_norm": r.summary.get("grad_clip_norm"),
